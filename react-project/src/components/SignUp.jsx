    ...
    <div className='signup'>
      ...
      <Form onSubmit={handleJoin}>
        ...
        <Form.Group className="mb-3" controlId="formBasicId">
          ...
          <Form.Control
            type="text" placeholder="아이디 (한글 불가)" ref={idRef} style={{ borderColor: text === '※ 사용 가능한 아이디입니다.' ? 'blue' : 'red' }}/>
        </Form.Group>
        ...
        <Form.Group className="mb-3" controlId="formBasicNick">
          ...
          <Form.Control
          type="text" placeholder="닉네임" ref={nicknameRef}/>
        </Form.Group>
        <div className='d-grid gap mb-3'>
       ...
       {/* onComplete={handlePostcodeComplete} */}
        ...
        <div className='d-grid gap mb-3'>
          <Button className="button"  variant='info' type='submit' >회원가입</Button>
        </div>
